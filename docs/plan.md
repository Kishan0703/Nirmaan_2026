# NIRMAAN 2026 — Event Plan

**Organizers:** Coding Club BMSIT × Alterino Club BMSIT
**Tagline:** Build. Innovate. Impact.
**Type:** National-level 24-hour innovation challenge for student builders across India.

## About
- National scale — open to student teams from colleges across India
- 24-hour sprint — idea to working prototype, one continuous day
- Real-world impact focus — solutions that matter beyond the stage

## Structure — Two Rounds
1. **Round 1** — Online PPT submission, open nationwide
...
2. **Embedded Systems / IoT (Multidisciplinary)** — blend of embedded computing, connectivity, software; systems-level innovation

## Judges & Mentors
- **Confirmed judge:** D Santhosh (Sandy) Kumar — Data Engineer at Walmart, 13x Hackathon Champion, 13+ Conference Speaker, Microsoft Certified Trainer, Azure Certified x6 (Python/Spark/Hive/SQL). Rest of panel TBA.
- **Mentors:** industry professionals from partner companies + college alumni, available throughout the 24-hr build.
...
## Why Participate
- Build real working prototype in 24 hrs
- Network with builders/mentors/industry leaders
- National exposure
- Internship opportunities for top performers
- Mentorship access throughout
