...
export function SocialInstagram({ className = "w-3.5 h-3.5" }: { className?: string }) {
  return (
...
export function SocialTwitter({ className = "w-3.5 h-3.5" }: { className?: string }) {
  return (
...
export function SocialLinkedin({ className = "w-3.5 h-3.5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function SocialGithub({ className = "w-3.5 h-3.5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
